  ...
  return (
    <section className="border-x border-b border-border">
      <div className="landing-gradient border-b border-border px-6 py-24 text-center sm:px-10 lg:px-24 lg:py-28">
        <h1 className="mx-auto max-w-[920px] text-[48px] font-bold leading-[1.08] tracking-normal text-text-black sm:text-[64px] lg:text-[78px]">
          Job hunting is hard.
          <br />
          Your tools should not be.
        </h1>
        <p className="mx-auto mt-8 max-w-[820px] text-[22px] font-normal leading-9 text-text-slate-medium">
      ...
      <div className="bg-surface-tertiary px-6 py-16 sm:px-10 lg:px-24">
        <div className="mx-auto max-w-[1450px] overflow-hidden rounded-xl">
          <Image
